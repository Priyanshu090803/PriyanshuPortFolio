  ...
  return (
    <div className=' px-10 py-1 items-center flex  z-[999] fixed w-full '>
      ...
      <div className=' w-28 overflow-hidden'>
       <h2 className=' italic -rotate-[10deg] font-plex text-2xl hover:scale-80 transition-all text-neutral-700 border rounded-2xl  hover:opacity-70 cursor-pointer duration-800 delay-150'>Priyanshu</h2>
      </div>
