...
const Navbar = () => {
  return (
    <div className=' md:px-10 px-4 py-2 items-center flex  z-[999] fixed w-full '>
      ...
      <div className=' links  font-plex items-center flex md:gap-12  gap-4 font-medium md:text-base  text-sm'>
        
        
        <a 
          className=' cursor-pointer md:text-xl text-sm hover:text-neutral-500 text-neutral-900 transition-all duration-600 ease-in-out  delay-100 hover:scale-95
